...
> **Note:** Please run `pip install transformers==4.38.2` after installation. Latest transformers version isn't compatible to Coqui TTS anymore. I'll provide a better solution soon. 
