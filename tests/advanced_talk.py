...
if __name__ == "__main__":
    ...
    if engine_name == "Azure":
        if not azure_speech_key:
            azure_speech_key = input(
                "Please enter your Azure subscription key (speech key): "
            )
        if not azure_speech_region:
            azure_speech_region = input(
                "Please enter your Azure service region (cloud region id): "
            )
    ...
    if engine_name == "Elevenlabs":
        if not elevenlabs_api_key:
            elevenlabs_api_key = input("Please enter your Elevenlabs api key: ")
