...
| [`QwenEngine`](engines/qwen.md) | Local native neural | `realtimetts[qwen]` after coordinated wheel release | NVIDIA GPU, reference audio, matching native wheel | In-process Q8 streaming, cached x-vector/ICL cloning, 24 kHz PCM. |
...
| [`InflectEngine`](engines/inflect.md) | Local lightweight | `realtimetts[inflect]` | Pinned Micro-v2 model, eSpeak-ng, PyTorch or ONNX Runtime | Fixed English male voice; PyTorch CUDA or ONNX CPU, 24 kHz PCM with PyAudio playback. |
